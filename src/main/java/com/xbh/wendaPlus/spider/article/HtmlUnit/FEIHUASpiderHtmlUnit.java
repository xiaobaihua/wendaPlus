...
import com.xbh.wendaPlus.spider.article.spiderParse.FEIHUASpiderParse;
...
//        BlockingQueue  queue = new LinkedBlockingDeque();
        ...
        try {
            ...
            FEIHUASpiderParse parse = new FEIHUASpiderParse();
            parse.parse(bean, document);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            FEIHUASpiderHtmlUnit.total++;
            SpiderController.completed ++;
            System.out.println(FEIHUASpiderHtmlUnit.total);
    ...
    public List<ArticleBean> getSearchData(List<ArticleBean> articleBeanList) throws InterruptedException {
        ...
        while (FEIHUASpiderHtmlUnit.total != articleBeanList.size()) {
            System.out.println(FEIHUASpiderHtmlUnit.total != articleBeanList.size());
            System.out.println(FEIHUASpiderHtmlUnit.total);
